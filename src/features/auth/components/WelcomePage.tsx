  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-900 flex flex-col overflow-hidden relative">
      ...
      >
        ...
        <Link href="/auth/signin" className="text-blue-200 hover:text-white text-sm font-medium transition-colors">
          Sign In
        </Link>
      </motion.nav>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-8 text-center">
        ...
        <motion.div {...fadeUp(0.5)} className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
          <Link href="/auth/signup" className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 px-8 rounded-xl text-base shadow-xl shadow-blue-900/50 transition-all hover:shadow-blue-700/40 hover:-translate-y-0.5 active:translate-y-0 text-center">
            Create Free Account
          </Link>
          <Link href="/auth/signin" className="flex-1 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 text-white font-semibold py-4 px-8 rounded-xl text-base transition-all hover:-translate-y-0.5 text-center">
            Sign In
          </Link>
        </motion.div>
